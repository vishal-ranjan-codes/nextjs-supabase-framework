            ...
            <div className="container-max-md">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="box p-6 bg-primary/5">
                            <h3 className="theme-h4 mb-4">Quick Links</h3>
                            <ul className="space-y-3">
                                <li>
                                    <a href="/design-system" className="theme-fc-base hover:text-primary transition-colors flex items-center gap-2">
                                ...
                                <li>
                                    <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="theme-fc-base hover:text-primary transition-colors flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    <a href="/about" className="theme-fc-base hover:text-primary transition-colors flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        </svg>
                                        About Us
                        ...
                        <div className="box p-6">
                            ...
                            <div className="flex gap-3">
                                <a
                                    ...
                                    className="bg-primary/12 hover:bg-primary hover:text-white theme-rounded w-10 h-10 flex items-center justify-center transition-colors"
                                >
